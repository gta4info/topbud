      ...
      <v-container>
        <v-row>
          <v-col
            ...
            :style="$vuetify.breakpoint.smAndDown ? 'padding-top: 0;position: sticky;top: 0;background: #fff;z-index: 2' : ''"
          >
            ...
            <v-container class="py-0">
              <v-row v-if="productsFiltered.length">
                <v-col cols="12" :class="{'px-0': $vuetify.breakpoint.smAndDown}">
                  <FiltersMobile :min="min" :max="max" :search="search" v-if="$vuetify.breakpoint.smAndDown"/>
                  <div class="sorting" :style="$vuetify.breakpoint.smAndDown ? 'margin-top: 10px;' : ''">
                    <v-select
...
export default {
  scrollToTop: true,
  head: {
    title: 'Weed delivery 🚬 OZ Deals in Toronto, best prices',
    meta: [
      {
        hid: 'description',
        name: 'description',
